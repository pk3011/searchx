...
def start(update, context):
    ...
    if update.message.chat.type == "private" :
        sendMessage(f"Hey <b>{update.message.chat.first_name}</b>. 💐Welcome to <b>TATAPLAY PREMIUM GROUP</b>", context.bot, update)
    else :
        sendMessage("मैं जिंदा हूँ भाई 🙏 :)", context.bot, update)
